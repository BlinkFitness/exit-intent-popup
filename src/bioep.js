...
const bioEp = {
  ...
  loadEvents: function() {
    ...
    this.addEvent(document, "mouseout", this.onMouseOverHandler.bind(this));
  ...
  onClose: function () {
    this.removeEvent(document, "mouseout", this.onMouseOverHandler.bind(this));
    this.removeEvent(document, "DOMContentLoaded", this.onInitHandler.bind(this));
  },
  ...
  init: function(opts) {
    ...
    this.domReady(this.onInitHandler.bind(this));
  }
};
